...
Based on the Unique Titles table, the COUNT() function was used get the number of titles. The data was then grouped by the titles to form the Retiring Titles tables. This will help give the company an overview of the number of positions need to be filled in the near future.
